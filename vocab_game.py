...
ans3 = st.text_input("ข้อ 3: Fly perfect `w i _ _ s`. 🪽",value=st.session_state.ans3_val,)

ans4 = st.text_input("ข้อ 4: When the `i m _ o _ t e r` is sus. 🤫",value=st.session_state.ans4_val,)
